 ...
 */
VA_AMS.models.ResponseStatus = function (jsonResponseStatus) {
    var convertResponseMessages = function(jsonMessages, messageType){
        ...
        jsonMessages.forEach(function (message, index, array) {
            ...
            msg = new VA_AMS.models.Message({type: messageType, value: message});
    ...
    var convertingArray2 = function(jsonMessages, messageType){
        ...
        for(index = 0; index < jsonMessages.length; index++){    //START Loop
            ...
            msg = new VA_AMS.models.Message({type: messageType, value: tempMsg});
    ...
    var determineMessageType = function(requestStatus){
        var messageType = (requestStatus.toLowerCase() === "Failure".toLowerCase()) ? VA_AMS.models.Message.ERROR : "";
        return messageType;
    };
    /**
     ...
     */
     var requestStatus = (Object.isDefined(jsonResponseStatus) && Object.isDefined(jsonResponseStatus.requestStatus)) ? jsonResponseStatus.requestStatus : "Failure",
         ...
         * @private
         * @field
         * @type {VA_AMS.models.ResponseException}
         */
        exception = (Object.isDefined(jsonResponseStatus) && Object.isDefined(jsonResponseStatus.exception)) ? new VA_AMS.models.ResponseException(jsonResponseStatus.exception) : null;
     ...
     * @public
     * @method
     * @returns {VA_AMS.models.ResponseException} The response requestStatus exception of a service call.
     */
