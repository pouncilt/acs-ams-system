var VA_AMS = VA_AMS || {};
VA_AMS.namespace = function (ns_string) {
	'use strict';
	var parts = ns_string.split('.'), parent = VA_AMS;
 ...
 **/
VA_AMS.defineClass = function (data) {
...
VA_AMS.enumeration = function (namesToValues) {
